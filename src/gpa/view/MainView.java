...
public class MainView {
    ...
    private Label title;
    private VBox courseFieldsContainer;
    ...
    public Scene getScene(MainApp mainApp) {
        ...
        courseFieldsContainer.setStyle("-fx-padding: 10px; " + "-fx-background-color: #f9f9f9; " + "-fx-border-color: #dddddd; "
        ...
        Button switchToCourseWorkButton = new Button("Switch to Course Work");
        switchToCourseWorkButton.setStyle("-fx-background-color: gold; " + "-fx-text-fill: black; "
                + "-fx-font-weight: bold; " + "-fx-padding: 10px 20px; " + "-fx-background-radius: 5px;");
        switchToCourseWorkButton.setOnAction(e -> mainApp.showCourseWorkCalculatorView());

        buttonField.getChildren().addAll(addCourseButton, calculateGPAButton, switchToCourseWorkButton);
